...
\label{tab:my-table}
\begin{tabular}{lllll}
        &        & shp+mark &     & baseline \\ \cline{3-5} 
Dataset & Metric & concat   & sum &          \\ \hline
SO      & NLL    &          &     &          \\
        & AUROC  &          &     &          \\
        & time   &          &     &          \\ \hline
Synthea & NLL    &          &     &          \\
...
\begin{table}[h!]
\centering
\caption{NLL estimation}
\label{tab:my-table}
\begin{tabular}{lllll}
\hline
        &         &    & Model  &          \\ \cline{3-5} 
Dataset & setting & TE & TE+DAM & TE+noise \\ \hline
P12     & sc      &    &        &          \\
        & mc1     &    &        &          \\
        & mc2     &    &        &          \\ \hline
p19     & sc      &    &        &          \\
...
\begin{table*}
\centering
\caption{Down stream task}
\label{tab:my-table}
\begin{tabular}{cccccccccccc}
\hline
                     &                      &        &  & F1   &        &  & AUPRC &        &  & AUROC &        \\ \cline{5-6} \cline{8-9} \cline{11-12} 
Dataset              & Setting              & Center &  & DAM  & TE+DAM &  & DAM   & TE+DAM &  & DAM   & TE+DAM \\ \hline
\multirow{8}{*}{P12} & \multirow{3}{*}{sc}  & 1      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
                     &                      & 2      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
                     &                      & 3      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\ \cline{2-12} 
                     & \multirow{3}{*}{mc1} & 1      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
                     &                      & 2      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
                     &                      & 3      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\ \cline{2-12} 
                     & mc2                  & -      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
                     & seft                 & -      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\ \hline
\multirow{8}{*}{P19} & \multirow{3}{*}{sc}  & 1      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
                     &                      & 2      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
                     &                      & 3      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\ \cline{2-12} 
                     & \multirow{3}{*}{mc1} & 1      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
                     &                      & 2      &  & 0.55 & 0.55   &  & 0.55  & 0.55   &  & 0.55  & 0.55   \\
